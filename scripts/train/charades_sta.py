...
available_corpus['charades_sta_ft'] = [
    {
        "dataset_name": 'charades_sta_grounding', 'grounding_method': 'choice',
        'label_file': f'{anno_root_it}/video/temporal/charades_sta_grounding-choice/train.json',
        'data_root': f'data/videos/charades', 'media_type': 'video'
    }
]

# ========================= data ==========================
train_corpus = "charades_sta_ft"
...
scheduler = dict(sched="cosine", epochs=10, min_lr_multi=0.25, warmup_epochs=0.6)
