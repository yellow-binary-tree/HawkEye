...
available_corpus['anetc_ft'] = [
    {
        "dataset_name": 'charades_sta_grounding', 'grounding_method': 'choice',
        'label_file': f'{anno_root_it}/video/temporal/anetc_grounding/train.json',
        'data_root': f'data/videos/activitynet', 'media_type': 'video', 'fps': 3
    }
]

# ========================= data ==========================
train_corpus = "anetc_ft"
