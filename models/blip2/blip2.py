...
class Blip2Base(nn.Module):
    ...
    def init_Qformer(
        # cls, 
        self,
        num_query_token, num_frame_tokens, vision_width,
        qformer_hidden_dropout_prob=0.1,
        qformer_attention_probs_dropout_prob=0.1,
        qformer_drop_path_rate=0.,
    ):
        encoder_config = BertConfig.from_pretrained(self.bert_path, local_files_only=True)
        encoder_config.num_frame_tokens = num_frame_tokens
